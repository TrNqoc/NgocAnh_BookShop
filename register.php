    ...
    <div class="container">
        <div id="register-container" class="card">
            <div class="row no-gutters shadow rounded">
                <div class="col-md-6">
                <img src="./images/bg/dk.jpg" class="card-img" alt="background">
                </div>
                <div class="col-md-6">
                    <div class="card-body">
                        ...
                        <form name="frmdangky" action="xulydangky.php" method="GET" >
                            ...
                            <div class="form-group">
                                ...
                                <p style="color:black;" id="checkmail"></p>
                            </div>
                            <div class="form-group">
                            ...
                            <button name="button" type="submit" class="btn btn-outline-danger btn-block mt-5">Đăng ký</button>
