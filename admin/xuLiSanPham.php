	...
	<div class="row">
		...
		<div class="search-container">
    		<form action="code.php" method="post">
                ...
                ?>
											<form action="code.php" method="POST">
												<button type="submit" class="btn btn-outline-info" name="btnDelSP" >Xóa</button>
												<input type="hidden" name="idSach" value="<?php echo $row['idSach']; ?>">
											</form>

											<!--<form action=""  method="POST">
												<button type="button" class="btn btn-outline-danger" name="btnDelSP" 
														data-toggle="modal" data-target="#DelModalSP<?php echo $row['idSach']; ?>">Xóa</button>
											</form>-->
...
<?php 
    ...
    if (mysqli_num_rows($query_run) > 0) {
        while ($row = mysqli_fetch_array($query_run)) {
            ...
            '
            <!-- Modal add -->
            <div class="modal fade" id="DelModalSP'.$row['idSach'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="code.php" method="POST">
                                    <input type="hidden" name="idSach" value="'.$row['idSach'].'">
                                    <button type="submit" class="btn btn-danger" name="btnDelSP">Xóa</button>
                                </form>
                            </div>
                        </div>
                    </div>
